...
const styles = StyleSheet.create({
  ...
  row: { flexDirection: 'row', gap: spacing.stackSm, marginBottom: spacing.stackMd },
  halfCard: { flex: 1, padding: spacing.stackMd },
  iconBox: {
    width: 36, height: 36, borderRadius: borderRadius.md,
    alignItems: 'center', justifyContent: 'center', marginBottom: 12,
  },
  cardLabel: { ...typography.labelSm, color: colors.onSurfaceVariant, marginBottom: 6 },
  bigNumber: { ...typography.bodyLg, fontWeight: '700', color: colors.onSurface },
  payCard: { padding: spacing.stackMd, marginBottom: spacing.stackMd },
  ...
  detailBtn: {
    ...
    borderRadius: borderRadius.lg, paddingVertical: 16, paddingHorizontal: spacing.stackMd,
    marginTop: spacing.stackMd, marginBottom: spacing.stackMd,
    shadowColor: '#000', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.15, shadowRadius: 8,
    elevation: 4,
  },
  detailBtnText: { ...typography.bodyLg, color: colors.onPrimary, fontWeight: '700', textAlign: 'center', flex: 1 },
});
