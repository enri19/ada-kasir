    ...
    if (id) {
      Promise.all([
        ...
        if (prod) {
          ...
          setUnit(prod.unit as ProductUnit);
          setSku(prod.sku || '');
  ...
  return (
    ...
    >
      ...
      <View style={styles.imageSection}>
        ...
        <Text style={styles.imageHint}>Ketuk untuk mengubah foto produk</Text>
      </View>
      ...
      <Card style={styles.card}>
        <View style={styles.toggleRow}>
          <View>
            <Text style={styles.toggleTitle}>Produk Aktif</Text>
            <Text style={styles.toggleSubtitle}>Munculkan produk di menu transaksi</Text>
          </View>
          <TouchableOpacity 
...
const styles = StyleSheet.create({
  ...
  toggleTitle: { ...typography.bodyLg, fontWeight: '600', color: colors.onSurface },
  toggleSubtitle: { ...typography.labelSm, color: colors.onSurfaceVariant, marginTop: 2 },
