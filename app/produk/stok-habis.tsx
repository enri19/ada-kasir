...
export default function StokHabisScreen() {
    ...
    <View style={[styles.container, { paddingTop: insets.top }]}> 
      <View style={styles.header}>
        <View style={styles.headerLeft}>
          ...
          <Text style={styles.headerTitle}>Stok Habis</Text>
        </View>
      </View>
      ...
      >
        {products.length === 0 ? (
          <View style={styles.emptyState}>
            ...
            <Text style={styles.emptyTitle}>Tidak ada produk habis</Text>
            <Text style={styles.emptyText}>Semua produk yang dipantau masih tersedia.</Text>
          </View>
        ) : (
            ...
            >
              ...
              <View style={styles.productInfo}>
                ...
                <View style={styles.detailsRow}>
                  ...
                  <Text style={[styles.detailValue, styles.stockLow]}>{product.stock}</Text>
                </View>
                <View style={styles.detailsRow}>
